...
import com.intellicoder.videodownloader.*
import com.intellicoder.videodownloader.Interfaces.UserListInStoryListner
import com.intellicoder.videodownloader.R
import com.intellicoder.videodownloader.adapters.ListAllStoriesOfUserAdapter
import com.intellicoder.videodownloader.adapters.StoryUsersListAdapter
import com.intellicoder.videodownloader.facebookstorysaver.fbadapters.FBstoryAdapter
import com.intellicoder.videodownloader.facebookstorysaver.fbadapters.FBuserRecyclerAdapter
import com.intellicoder.videodownloader.facebookstorysaver.fbinterfaces.OnFbUserClicked
import com.intellicoder.videodownloader.facebookstorysaver.fbmodels.FBStory
import com.intellicoder.videodownloader.facebookstorysaver.fbmodels.FBUserData
import com.intellicoder.videodownloader.facebookstorysaver.fbutils.FBhelper
import com.intellicoder.videodownloader.facebookstorysaver.fbutils.Facebookprefloader
import com.intellicoder.videodownloader.facebookstorysaver.fbutils.LoginWithFB
import com.intellicoder.videodownloader.models.storymodels.*
import com.intellicoder.videodownloader.receiver.Receiver
import com.intellicoder.videodownloader.services.ClipboardMonitor
import com.intellicoder.videodownloader.tasks.downloadFile
import com.intellicoder.videodownloader.tasks.downloadVideo
import com.intellicoder.videodownloader.utils.Constants
import com.intellicoder.videodownloader.utils.Constants.PREF_CLIP
import com.intellicoder.videodownloader.utils.Constants.STARTFOREGROUND_ACTION
import com.intellicoder.videodownloader.utils.Constants.STOPFOREGROUND_ACTION
...
import com.intellicoder.videodownloader.utils.iUtils.ShowToast
import com.intellicoder.videodownloader.utils.iUtils.isPackageInstalled
...
class download : Fragment(), UserListInStoryListner {
    ...
    private var tipsTitleImage:ImageView? = null
    private var tipsTitleText:TextView? = null
    private var tipsTitleLayout:LinearLayout? = null
...
var receiver: BroadcastReceiver? = null
    ...
    override fun onCreateView(
        ...
        tipsTitleText = view.findViewById(R.id.download_tip_text) as TextView
        tipsTitleImage = view.findViewById(R.id.bulb_icon_tip) as ImageView
        tipsTitleLayout = view.findViewById(R.id.downloader_liner_layout) as LinearLayout
        llTips = view.findViewById(R.id.llTips) as LinearLayout

        tipsTitleLayout!!.setOnClickListener { showingTips() }
        tipsTitleText!!.setOnClickListener { showingTips()  }
        tipsTitleImage!!.setOnClickListener { showingTips()  }
